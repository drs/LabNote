...
LOG_FILE_PATH = os.path.join(DEFAULT_MAIN_DIRECTORY_PATH + "/logs")
LOG_FILE = os.path.join(LOG_FILE_PATH + "/{}_labnote.log".format(datetime.datetime.now().strftime("%Y-%m-%d")))
