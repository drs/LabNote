...
class Ui_Dataset(object):
    def setupUi(self, Dataset):
        ...
        self.btn_folder = QtWidgets.QToolButton(Dataset)
        self.btn_folder.setText("")
        self.btn_folder.setObjectName("btn_folder")
        self.layout_search.addWidget(self.btn_folder)
        ...
        self.btn_rmd = QtWidgets.QToolButton(Dataset)
        self.btn_rmd.setText("")
        self.btn_rmd.setObjectName("btn_rmd")
        self.layout_search.addWidget(self.btn_rmd)
        ...
        self.layout_search.addItem(spacerItem8)
        ...
        self.layout_search.addItem(spacerItem9)
